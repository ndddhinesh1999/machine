                            ...
                            <div class="card-body">
                                <form action="index.php" method="POST" name="department_form" id="department_form" autocomplete="off" class="needs-validation" novalidate>
                                    <div class="row">
                                        ...
                                        <?php    } ?>
                                        <div class="col-md-4">
                                            <label class="form-label department_name" for="department_name">MACHINE NAME</label>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label department_name" for="department_name">MACHINE MODEL</label>
                                            <input name="department_name" id="department_name" class="form-control" required>
                                            <div class="invalid-feedback">
                                                Please enter department name.
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label department_name" for="department_name">MACHINE SYSTEM</label>
                                            <input name="department_name" id="department_name" class="form-control" required>
                                            <div class="invalid-feedback">
                                                Please enter department name.
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label department_name" for="department_name">MACHINE SERIAL NUMBER</label>
                                            <input name="department_name" id="department_name" class="form-control" required>
                                            <div class="invalid-feedback">
                                                Please enter department name.
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label department_name" for="department_name">YEAR OF MANUFACTURE</label>
                                            <input name="department_name" id="department_name" class="form-control" required>
                                            <div class="invalid-feedback">
                                                Please enter department name.
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label department_name" for="department_name">LOCATION</label>
                                            <input name="department_name" id="department_name" class="form-control" required>
                                            <div class="invalid-feedback">
                                                Please enter department name.
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label department_name" for="department_name">PREVIOUSLY MAINTENANCE DONE</label>
                                            <input name="department_name" id="department_name" class="form-control" required>
                                            <div class="invalid-feedback">
                                                Please enter department name.
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label department_name" for="department_name">PLANNED MAINTENANCE</label>
                                            <input name="department_name" id="department_name" class="form-control" required>
                                            <div class="invalid-feedback">
                                                Please enter department name.
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label department_name" for="department_name">X-axis</label>
                                            <input name="department_name" id="department_name" class="form-control" required>
                                            <div class="invalid-feedback">
                                                Please enter department name.
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label department_name" for="department_name">Y-axis</label>
                                            <input name="department_name" id="department_name" class="form-control" required>
                                            <div class="invalid-feedback">
                                                Please enter department name.
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label department_name" for="department_name">Z-axis</label>
                                            <input name="department_name" id="department_name" class="form-control" required>
                                            <div class="invalid-feedback">
                                                Please enter department name.
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label department_name" for="department_name">Tool storage capacity</label>
                                            <input name="department_name" id="department_name" class="form-control" required>
                                            <div class="invalid-feedback">
                                                Please enter department name.
                                            </div>
