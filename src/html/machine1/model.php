    ...
    if (isset($_POST['add_department'])) {
        ...
        if ($num_row == 0) {
            if (!empty($request_fields)) {
                ...
                $insert_department = "INSERT INTO departments  SET 
				  department_name='" . $department_name . "',
            
                  department_company_id='" . $company_id . "',
				  department_uniq_id='" . $uniq_id . "',													
				  department_added_by='" . $_SESSION[SESS . 'session_admin_users_id'] . "',
				  department_added_on=UNIX_TIMESTAMP(NOW()),
				  department_added_ip='" . $ip . "'";
